MODULE GammaHeating
    ...
    ! Input
    !
    ! WaterDensity - Density of the water (kg/m^3)
    !
    ! Output
    !
    ...
    !
    REAL(r8k) :: WaterDensity_gcm3
    REAL(r8k), INTENT(IN) :: WaterDensity
    REAL(r8k), PARAMETER :: GammaClad_Min = 1.0e-10_r8k
    
    ! Convert kg/m3 to g/cm3
    WaterDensity_gcm3 = WaterDensity * 0.001_r8k
    
    ! Cladding gamma-ray heating fraction
    GammaClad = 2.4682E-2_r8k - 5.91E-4_r8k * WaterDensity_gcm3 - 8.98E-4_r8k * WaterDensity_gcm3 ** 2
    ...
    GammaCoolant = 3.453E-3_r8k + 2.613E-2_r8k * WaterDensity_gcm3 - 3.228E-3_r8k * WaterDensity_gcm3 ** 2
